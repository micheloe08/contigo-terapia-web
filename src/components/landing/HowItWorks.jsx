    ...
    <section className="py-12 md:py-16">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-2xl md:text-3xl text-slate-900 mb-8 md:mb-10">
          <span className="font-light">Así de fácil es</span> <span className="font-semibold">empezar</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {STEPS.map((s) => (
            <div
              key={s.num}
              className="bg-blue-50 border-0 rounded-2xl p-6 md:p-8 text-center hover:shadow-sm transition-shadow"
            >
